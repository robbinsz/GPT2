...
def set_args():
    ...
    parser.add_argument('--output_dir', default=r'C:\Users\Wang\Desktop\GPT2-NewsTitle-main\output_dir\checkpoint-best', type=str, help='模型文件路径')
    parser.add_argument('--vocab_path', default=r'C:\Users\Wang\Desktop\GPT2-NewsTitle-main\vocab\vocab.txt', type=str, help='词表，该词表为小词表，并增加了一些新的标记')
    ...
    parser.add_argument('--http_id', type=str, default="127.0.0.1", help='ip地址')
...
def start_sever():
    ...
    server = WSGIServer((str(args.http_id), args.port), app)
